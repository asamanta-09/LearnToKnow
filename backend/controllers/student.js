...
exports.login = async (req, res) => {
  try {
    ...
    const payload = {
      id: student._id,
      email: student.email,
      role: "student", //here we can add other things that student is subscribed or not etc.. and based on this authorization can be done at the middlewire section and add that middlewire to a particular route that checks for authorization to access it
    };
